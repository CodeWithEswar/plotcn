    ...
    <section id="section-responsive" className="space-y-6 pt-4 scroll-mt-20">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-2 pb-2 border-b border-white/[0.06]">
                <div className="flex items-center gap-2 text-xs font-mono font-semibold text-foreground min-w-0">
                  <HugeiconsIcon
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-black/40 p-3.5 sm:p-4 space-y-2 overflow-hidden">
          <div className="flex items-center justify-between text-xs font-mono text-zinc-400">
            <span className="flex items-center gap-1.5 font-medium text-zinc-200">
              <HugeiconsIcon icon={Tablet01Icon} size={14} className="shrink-0 text-muted-foreground" />
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-black/40 p-3.5 sm:p-4 space-y-2 overflow-hidden">
          <div className="flex items-center justify-between text-xs font-mono text-zinc-400">
            <span className="flex items-center gap-1.5 font-medium text-zinc-200">
              <HugeiconsIcon icon={SmartPhone01Icon} size={14} className="shrink-0 text-muted-foreground" />
