...
Modern versions of shadcn support external namespaced registries directly in `components.json`.
...
Once the `@plotcn` namespace is configured, you install visualization components just like standard shadcn primitives:
