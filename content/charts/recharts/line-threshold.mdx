...
:::package-manager
npx shadcn@latest add https://plotcn.vercel.app/r/line-threshold.json
:::

> Once accepted into the official shadcn registry catalog, the shortened command `npx shadcn@latest add @plotcn/line-threshold` becomes available.
