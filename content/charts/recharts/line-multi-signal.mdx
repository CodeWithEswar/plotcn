...
:::package-manager
npx shadcn@latest add https://plotcn.vercel.app/r/line-multi-signal.json
:::

> Once accepted into the official shadcn registry catalog, the standard command `npx shadcn@latest add @plotcn/line-multi-signal` becomes available.
